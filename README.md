...
Чтобы не искать ответы на теоритические вопросы, публикую их на [соседней страничке](questions.md).   
Практических вопросов с написанием кода может быть бесконечное количество, и они занимают много места, поэтому их не публикую.

Что ж, с подготовкой странички с вопросами-ответами по C# закончено. Опять получилось долго.   
Следующий этап. Я, как любитель ASP.NET, считаю, что мне надо дочитать [учебник по ASP.NET](https://metanit.com/sharp/aspnet5/). Некоторые темы были сложны для меня, некоторые не успел прочесть. Просто прочитать, без всяких самопроверок. Максимум, проверить, работает ли написанное автором в Visual Studio 2019 (естественно, без тупого copy-paste).

_Написано_: 28.11.2021
